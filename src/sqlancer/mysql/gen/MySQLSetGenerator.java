...
//        }
    ...
    private enum Action implements ConfigurationAction{
        ...
        BULK_INSERT_BUFFER_SIZE("bulk_insert_buffer_size", (r) -> r.getLongWithBoundaryBias(0, Long.MAX_VALUE), Scope.GLOBAL, //
                Scope.SESSION), //
        ...
        CTE_MAX_RECURSION_DEPTH("cte_max_recursion_depth", //
                (r) -> r.getLongWithBoundaryBias(0, 4294967295L), Scope.GLOBAL), //
        DELAY_KEY_WRITE("delay_key_write", (r) -> Randomly.fromOptions("ON", "OFF", "ALL"), Scope.GLOBAL), //
        EQ_RANGE_INDEX_DIVE_LIMIT("eq_range_index_dive_limit", (r) -> r.getLongWithBoundaryBias(0, 4294967295L), Scope.GLOBAL), //
        ...
        HISTOGRAM_GENERATION_MAX_MEM_SIZE("histogram_generation_max_mem_size",
                (r) -> r.getLongWithBoundaryBias(1000000, Long.MAX_VALUE), Scope.GLOBAL, Scope.SESSION), //
        ...
        MAX_HEAP_TABLE_SIZE("max_heap_table_size", (r) -> r.getLongWithBoundaryBias(16384, Long.MAX_VALUE), Scope.GLOBAL,
                Scope.SESSION), //
        MAX_LENGTH_FOR_SORT_DATA("max_length_for_sort_data", (r) -> r.getLongWithBoundaryBias(4, 8388608), Scope.GLOBAL, Scope.SESSION), //
        MAX_POINTS_IN_GEOMETRY("max_points_in_geometry", (r) -> r.getLongWithBoundaryBias(4, 1048576), Scope.GLOBAL, Scope.SESSION), //
        ...
        MYISAM_DATA_POINTER_SIZE("myisam_data_pointer_size", (r) -> r.getLongWithBoundaryBias(2, 7), Scope.GLOBAL), //
        MYISAM_MAX_SORT_FILE_SIZE("myisam_max_sort_file_size", (r) -> r.getLongWithBoundaryBias(0, 9223372036854775807L), Scope.GLOBAL), //
        MYISAM_SORT_BUFFER_SIZE("myisam_sort_buffer_size", (r) -> r.getLongWithBoundaryBias(4096, Long.MAX_VALUE), Scope.GLOBAL,
                Scope.SESSION), //
        ...
        PARSER_MAX_MEM_SIZE("parser_max_mem_size", (r) -> r.getLongWithBoundaryBias(10000000, Long.MAX_VALUE), Scope.GLOBAL,
                Scope.SESSION), //
        PRELOAD_BUFFER_SIZE("preload_buffer_size", (r) -> r.getLongWithBoundaryBias(1024, 1073741824), Scope.GLOBAL, Scope.SESSION), //
        QUERY_ALLOC_BLOCK_SIZE("query_alloc_block_size", (r) -> r.getLongWithBoundaryBias(1024, 4294967295L), Scope.GLOBAL,
                Scope.SESSION), //
        QUERY_PREALLOC_SIZE("query_prealloc_size", (r) -> r.getLongWithBoundaryBias(8192, Long.MAX_VALUE), Scope.GLOBAL, Scope.SESSION), //
        RANGE_ALLOC_BLOCK_SIZE("range_alloc_block_size", (r) -> r.getLongWithBoundaryBias(4096, Long.MAX_VALUE), Scope.GLOBAL,
                Scope.SESSION), //
        RANGE_OPTIMIZER_MAX_MEM_SIZE("range_optimizer_max_mem_size", (r) -> r.getLongWithBoundaryBias(0, Long.MAX_VALUE), Scope.GLOBAL,
                Scope.SESSION),
        /*
        ...
        RBR_EXEC_MODE("rbr_exec_mode", (r) -> Randomly.fromOptions("IDEMPOTENT", "STRICT"), //
                Scope.SESSION), //
        READ_BUFFER_SIZE("read_buffer_size", (r) -> r.getLongWithBoundaryBias(8200, 2147479552), Scope.GLOBAL, Scope.SESSION), //
         ...
         */
        // SORT_BUFFER_SIZE("sort_buffer_size", (r) -> r.getLongWithBoundaryBias(32768,
        // Long.MAX_VALUE)),
